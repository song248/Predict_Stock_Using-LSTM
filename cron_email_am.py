...
from cron_prophet_am import fb_main_am
import numpy as np
...
class EmailHTMLContent:
    # 이메일에 담길 컨텐츠
    def __init__(self, str_subject, str_image_file_name1,str_image_file_name2,template, template_params1, template_params2, template_params3, template_params4):
        ...
        assert isinstance(template_params4, dict)
        ...
        # 이메일 본문 설정
        str_msg = template.safe_substitute(**template_params1, **template_params2, **template_params3, **template_params4) # ${변수} 치환하며 문자열 만듬
...
for i in comp:
    ...
    a = []
    # corsor_comp
    cursor_group.execute("SELECT DISTINCT content FROM blog_moredata WHERE email = (?);", (data,))
    corp_list = cursor_group.fetchall() # 출력 예시 (이메일, ('카카오게임즈',), ('삼성전자',)]
    tmp = []
    out = {}
...
for key, value in output.items(): # db_comp = 기업 정보들
    ...
    for corp in value:
        ...
        try:
            ...
            # 기업별로 email 전송
            closing = '/home/ubuntu/final_django_1/closing_img.png'
            real_am = '/home/ubuntu/final_django_1/real_am.png'
            ...
            template = Template("""<html>
                                        ...
                                        <body>
                                            ...
                                            해당 종목의 종가 예측값은 ${stock} 입니다. <br>
                                            해당 종목의 오전 추천 매수가는 ${real1} 입니다.<br>
                                            해당 종목의 오전 추천 매도가는 ${real2} 입니다.<br>
                                        </body>
                                    </html>""")
            ...
            template_params4 = {'stock':tomorrow_prediction[0]}
            str_image_file_name1 = closing
            str_image_file_name2 = real_am
            str_cid_name1 = 'my_image1'
            str_cid_name2 = 'my_image2'

            emailHTMLContent = EmailHTMLContent(str_subject, str_image_file_name1,str_image_file_name2, template, template_params1, template_params2, template_params3,template_params4)
