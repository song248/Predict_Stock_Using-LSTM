...
stock_name = ['034730.KS','030200.KS', '003550.KS', '035720.KS', '035420.KS', '005930.KS']
...
for name in stock_name:
    ...
    # 034730:sk / 030200:KT / 003550:LG / 035720:카카오 / 035420:네이버 / 005930:삼성전자
    test_file = open("./jobj/{}_stock_test.csv".format(name), 'w', encoding='utf-8', newline ="")
    test_writer = csv.writer(test_file)
    for row in test:
        test_writer.writerow([row])
    test_file.close()

    pred_file = open("./jobj/{}_stock_predict.csv".format(name), 'w', encoding='utf-8', newline ="")
